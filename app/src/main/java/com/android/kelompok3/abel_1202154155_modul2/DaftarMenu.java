...
public class DaftarMenu extends RecyclerView.Adapter <DaftarMenu.ViewHolder> {
    ...
    DaftarMenu(ArrayList<String> arrayListMenu, ArrayList<String> arrayListsPrice, ArrayList<Integer> Gambar){
    ...
    public DaftarMenu.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType){
    ...
    public void onBindViewHolder(final DaftarMenu.ViewHolder holder, final int position) {
        //Memanggil Nilai/Value Pada View-View Yang Telah Dibuat pada Posisi Tertentu

        final String menu = arrayListMenu.get(position);//Mengambil data sesuai dengan posisi yang telah ditentukan
        final String price = arrayListsPrice.get(position);//Mengambil data sesuai dengan posisi yang ditentukan
        final Integer image = gambar.get(position);//Mengambil data sesuai dengan posisi yang ditentukan
            ...
            public void onClick(View view) {
                ...
                switch (position){
                    ...
                    case 4:
                        ...
                        komposisi = "Nasi, Saus Teriyaki, Daging Wagyu";
                    ...
                    case 5:
                        ...
                        komposisi = "Mie Pilihan, Sayuran, Kecap";
